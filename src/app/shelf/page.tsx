  ...
  return (
    <PageTransition>
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="hidden md:block relative w-full" style={{ height: "75vh", minHeight: 600 }}>
